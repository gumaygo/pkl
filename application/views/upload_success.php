    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">  
          <a class="navbar-brand brand-logo" href="<?php echo base_url('/user'); ?>"><img src="<?php echo base_url('/assets/'); ?>images/logo.svg" alt="logo"/></a>
          <a class="navbar-brand brand-logo-mini" href="<?php echo base_url('/user'); ?>"><img src="<?php echo base_url('/assets/'); ?>images/logo-mini.svg" alt="logo"/></a>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
         ...
         <!--  <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="<?php echo base_url('/assets/'); ?>#ui-basic" aria-expanded="false" aria-controls="ui-basic">
            ...
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between flex-wrap">
                ...
                <div class="d-flex justify-content-between align-items-end flex-wrap">
                  <a href="download" type="button" class="btn btn-light bg-white btn-icon mr-2 d-none d-md-block ">
                    <i class="mdi mdi-download text-muted"></i>
                  </a>
                  <a href ="history" class="btn btn-light bg-white btn-icon mr-3 mt-2 mt-xl-0">
                    <i class="mdi mdi-clock-outline text-muted"></i>
                  </a>
                  <a href="upload" type="button" class="btn btn-light bg-white btn-icon mr-3 mt-2 mt-xl-0">
                      ...
                      <div class="d-flex flex-wrap justify-content-xl-between">
                        <div class="d-none d-xl-flex border-md-right flex-grow-1 align-items-center justify-content-center p-3 item">
                          ...
                          <div class="d-flex flex-column justify-content-around">
                            ...
                            <div class="dropdown">
                              <a class="btn btn-secondary dropdown-toggle p-0 bg-transparent border-0 text-dark shadow-none font-weight-medium" href="<?php echo base_url('/assets/'); ?>#" role="button" id="dropdownMenuLinkA" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
<?php endforeach; ?>
    ...
    <p><?php echo anchor('upload', 'Upload Another File!'); ?></p>
        ...
        <!-- partial:partials/_footer.html --> 
         <div class="col-md-20 grid-margin stretch-card"> </div>
        <footer class="footer">
