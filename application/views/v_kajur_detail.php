...
?>
    ...
    <div class="pos" id="_0:0" style="top:0">
      ...
      <div class="pos" id="_118:941" style="top:941;left:118">
        ...
        <a href="<?php echo base_url('kajur/terima/'). $id_request; ?>"  class="btn btn-success">Setujui</a>
      </div>
      <div class="pos" id="_468:941" style="top:941;left:468">
        <span id="_16.3" style=" font-family:Times New Roman; font-size:16.3px; color:#000000">
        NPM</span>
</br></br></br></br></br></br>
        <a href="<?php echo base_url('kajur/tolak/'). $id_request; ?>" class="btn btn-danger">Tolak</a>
      </div>
