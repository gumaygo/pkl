            ...
            <div class="col-md-12 grid-margin">
              <div class="card bg-gradient-primary border-0">
                <div class="card-body py-3 px-4 d-flex align-items-center justify-content-between flex-wrap">
                  ...
                  <div class="d-flex">
                    <a href="<?php echo base_url('/assets/'); ?>https://github.com/Bootstrapdash/MajesticAdmin-Free-Bootstrap-Admin-Template" target="_blank" class="btn btn-outline-light mr-2">Download free version</a>
                    <a href="<?php echo base_url('/assets/'); ?>http://www.bootstrapdash.com/demo/majestic-admin-pro/template/" target="_blank" class="btn btn-outline-light mr-2 bg-gradient-danger border-0">Upgrade to Pro</a>
                          ...
                          <div class="d-flex flex-column justify-content-around">
                            ...
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenuLinkA">
                                <a class="dropdown-item" href="<?php echo base_url('/assets/'); ?>#">12 Aug 2018</a>
                                <a class="dropdown-item" href="<?php echo base_url('/assets/'); ?>#">22 Sep 2018</a>
                                <a class="dropdown-item" href="<?php echo base_url('/assets/'); ?>#">21 Oct 2018</a>
                              </div>
                            </div>
                          </div>
                        </div>
