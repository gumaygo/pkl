        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12 stretch-card">
              <div class="card">
                <div class="card-body">
                 <a class="card-title">Recent Request Surat Aktif</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a  class ='btn btn-primary mt-2 mt-xl-0'  href="<?php echo base_url('/pudir/index'); ?>"> Permintaan surat aktif </a>
                  <div class="table-responsive">
                    <table id="recent-purchases-listing" class="table">
                      ...
                      <tbody>
                        ...
                        <?php $query = $this->db->query("select request.id, request.npm, request.status, mahasiswa.nama, permintaan_surat.nama_permintaan, request.id_permintaan, request.nama_orangtua, request.nip_orangtua, request.pekerjaan_orangtua,request.pangkat_orangtua,request.instansi_orangtua, request.alamat_orangtua, request.foto_ukt, request.foto_daftarulang, request.tanggal FROM request INNER JOIN Permintaan_surat on Permintaan_surat.id = request.id_permintaan JOIN mahasiswa ON mahasiswa.npm = request.npm where request.status = '1' and request.id_permintaan = '2'");
                        $ii=1;
                        foreach ($query->result_array() as $row)
                        {
                          ...
                          if ($row['status'] == '0') {
                           echo "<td> <label class='badge badge-warning'>Menunggu Konfirmasi</label></td>" ;
                         }elseif ($row['status'] == '1') {
                           echo "<td> <label class='badge badge-info'>Menunggu Konfirmasi</label></td>" ;
                         }elseif ($row['status'] == '2') {
                           echo "<td> <label class='badge badge-success'>Di Terima</label></td>" ;
                           echo "<td> <a href ='download'>download </td>" 
                           ;
                         }elseif ($row['status'] == '3') {
                         ...
                         <form method='post' action='".base_url('/pudir/detail')."'>
                         <input hidden type='text' name='id_request' value='".$row['id']."'>
                         <input class='btn btn-inverse-primary btn-fw' type='submit' name='submit' value='Detail'>
