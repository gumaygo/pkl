...
<body>
  <div class="container-scroller">
            ...
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between flex-wrap">
                ...
                <div class="d-flex justify-content-between align-items-end flex-wrap">
                  ...
                  <button onclick="window.location.href='<?php echo base_url('/mahasiswa/add'); ?>'" type="button" class="btn btn-light bg-white btn-icon mr-3 mt-2 mt-xl-0">
   ...
   <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">form Permintaan Surat Aktif</h4>
                  <p class="card-description">
                    Data diri anda telah di isi secara otomatis, silakan Isi data orang tua anda dengan benar sebagai syarat permintaan surat.
                  </p>       
         <!-- Display Message -->
    <b><?php if(isset($filenames)) echo "Successfully uploaded ".count($filenames)." files"; ?></b>
    
    <!-- Form -->
    <form method='post' action='<?php echo base_url('/mahasiswa/inputdata2'); ?>' enctype='multipart/form-data'>
      <div class="form-group">
                      <label for="exampleInputUsername1">Nama Orang Tua</label>
                      <input type="text" class="form-control" name="nama_orangtua" id="" placeholder="nama orang tua">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Nip Orang Tua</label>
                      <input type="text" class="form-control" name="nip_orangtua" id="exampleInputEmail1" placeholder="nip orang tua">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputConfirmPassword1">pekerjaan Orang Tua</label>
                      <input type="text" class="form-control" name="pekerjaan_orangtua" id="exampleInputConfirmPassword1" placeholder="pekerjaan orang tua">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputConfirmPassword1">Pangkat Orang Tua</label>
                      <input type="text" class="form-control" name="pangkat_orangtua" id="exampleInputConfirmPassword1" placeholder="pekerjaan orang tua">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputConfirmPassword1">instansi orang tua</label>
                      <input type="text" class="form-control" name="instansi_orangtua" id="exampleInputConfirmPassword1" placeholder="Instansi">
                    </div>
                    <div class="form-group">
                      <label >Scan Bukti Ukt</label>
                      <input class="form-control" type='file' name='files[]' multiple > 
                    </div>
                    <div class="form-group">
                      <label >Scan Bukti Daftar Ulang</label>
                      <input class="form-control" type='file' name='files[]' multiple > 
                    </div>
                    
      <div class="form-group">
                      <label for="exampleTextarea1">Alamat</label>
                      <textarea name="alamat_orangtua" class="form-control" id="exampleTextarea1" rows="4"></textarea>
                    </div>
      ...
      <input type='submit' class="btn btn-primary mr-2" value='Upload' name='upload' />
    </form>
      </div>
              </div>
            </div>
