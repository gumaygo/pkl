...
<body>
  ...
  <img class="card-img-top" src="../assets/images/card/images.png" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">SURAT KETERANGAN MASIH KULIAH</h5>
    <p class="card-text">Surat keterangan masih kuliah adalah surat keterangan yang menjelaskan bahwa mahasiswa yang bersangkutan merupakan mahasiswa aktif di Politeknik Negeri Lampung .</p>
    <a href="<?php echo base_url('/mahasiswa/input'); ?>" class="btn btn-primary">Buat Surat</a>
  </div>
</div><div class="card" style="width: 22rem;">
  <img class="card-img-top" src="../assets/images/card/images.png" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">SKPI</h5>
    <p class="card-text">Surat Keterangan Pendamping Ijazah selanjutnya disebut SKPI adalah dokumen yang memuat informasi tentang pencapaian akademik atau kualifikasi dari lulusan pendidikan tinggi bergelatr.</p>
    <a href="<?php echo base_url('/mahasiswa/input'); ?>" class="btn btn-primary">Buat Surat</a>
  </div>
</div><div class="card" style="width: 22rem;">
  <img class="card-img-top" src="../assets/images/card/images.png" alt="Card image cap">
  <div class="card-body">
    ...
    <p class="card-text">Cuti mahasiswa adalah penundaan kegiatan akademik dalam batas waktu tertentu yang dilakukan mahasiswa dengan alasan yang sah .</p>
    <a href="<?php echo base_url('/mahasiswa/input2'); ?>" class="btn btn-primary">Buat Surat</a>
  </div>
</div>
